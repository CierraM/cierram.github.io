...
function getWeather() {
    ...
    const townId = '5607916'
    let url = `https://api.openweathermap.org/data/2.5/weather?id=${townId}&appid=${appid}`
    ...
    fetch(url)
      ...
      .then((jsObject) => {
        ...
        let forecastURL = `https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=0b209e7419e85240602a2b16775256c6`
        fetch(forecastURL)
            .then((response) => response.json())
            .then((jsObject) =>{
